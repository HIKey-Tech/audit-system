...
exports.renderDocxFromDocumentXml = exports.DOCX_MIME_TYPE = void 0;
 ...
 */
const renderDocxFromDocumentXml = (documentXml, data) => {
    ...
    try {
        ...
        logger_util_1.logger.error('Failed to render DOCX template', { err });
        throw app_error_1.AppError.internal();
    }
    return doc.getZip().generate({ type: 'nodebuffer', compression: 'DEFLATE' });
};
exports.renderDocxFromDocumentXml = renderDocxFromDocumentXml;
//# sourceMappingURL=docx-template.utility.js.map