...
export declare const JOB_KEYS: {
    ...
    readonly USER_MFA_GRACE_REMINDER_DAILY: "BG:USER:MFA_GRACE_REMINDER:DAILY";
    ...
    readonly INTEGRATION_DIRECTORY_SYNC_DAILY: "BG:INTEGRATION:DIRECTORY:SYNC:DAILY";
    readonly RETENTION_PURGE_WEEKLY: "BG:RETENTION:PURGE:WEEKLY";
};
