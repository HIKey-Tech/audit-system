...
import { DEFAULT_CHECKLIST_TEMPLATE_CONFIG } from '../src/modules/audit/utility/audit-config.utility';
...
const WORKING_PAPER_TEMPLATES: Array<{
  ...
  },
  {
    ...
    description: 'Working paper structure for configuration, change, and continuity procedures within the merged System/IT domain.',
    auditType: 'it',
    isDefault: false,
    sections: [
...
const SYSTEM_CONFIGS: Array<{
  ...
  },
  {
    key: 'audit_taxonomy',
    value: JSON.stringify({
      auditTypes: ['it', 'financial', 'compliance'],
  ...
  },
  {
    ...
    // The catalogue itself lives in CONTROL_SETS so the seed, the checklist
    // service, and the compliance seeder cannot drift apart.
    value: JSON.stringify(DEFAULT_CHECKLIST_TEMPLATE_CONFIG, null, 2),
